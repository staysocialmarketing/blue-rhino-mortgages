    ...
    items: [
      {
        ...
        a: 'Don\'t just sign what your lender sends you. Most renewal offers are not their best rate — they\'re betting on inertia. Start looking 4–6 months out. We\'ll shop the market, compare renewal vs. refinance options, and make sure you\'re going into the next term with the right structure — not just the same one by default.',
      },
      {
